...
$(document).ready(function () {
    ...
    tabladata = $('#tbCobro').DataTable({
        "ajax": {
            "url": $.MisUrls.url._ObtenerCobros + "?fechainicio=" + ObtenerFecha() + "&fechafin=" + ObtenerFecha() + "&numerodocumento=&nombres=",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
...
function buscar() {
    ...
    tabladata.ajax.url($.MisUrls.url._ObtenerCobros + "?" +
